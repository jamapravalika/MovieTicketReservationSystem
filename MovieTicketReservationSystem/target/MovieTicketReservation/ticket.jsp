        ...
        <div class="ticket-body">
            <div class="ticket">
                ...
                <div class="title">
                    ...
                    <%
    Bookings booking = (Bookings) request.getAttribute("bookings");
    if (booking != null) {
%>
...
%>
        ...
        <input type="button" name="previous-step" class="home-page-btn" value="Browse to Home Page" onclick="location.href='Home.jsp';" />
    </fieldset>
</body>
</html>

			...
			<div class="container">
				<div class="signin-content">
					<div class="signin-image">
						<figure>
							<img src="assets/images/setting.png" alt="sing up image">
						</figure>
						<a href="AdminReg.jsp" class="signup-image-link">Create an
							account</a>
					</div>
					<div class="signin-form">
						...
						<form method="post" action="AdminLogin" class="register-form"
							...
							<div class="form-group">
                            <label for="role"><i class="zmdi zmdi-admin"></i></label>

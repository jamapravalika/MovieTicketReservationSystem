...
<%@ include file="Header.jsp" %>
	...
	<section class="w3l-clients" id="clients">
		...
		<div class="container py-lg-4">
			...
			<!-- /grids -->
			<div class="testimonial-width" style="display: flex;">
				<div class="owl-clients owl-carousel owl-theme mb-lg-5">
					<div class="item">
						<div class="testimonial-content">
							<div class="testimonial">
								<blockquote>
									<q>Movies now make up a huge part of the entertainment industry.
									 But with so many choices comes the problem of finding the best ones to watch. This is the Best One!</q>
								</blockquote>
								<div class="testi-des">
					...
					<div class="item">
						<div class="testimonial-content">
							<div class="testimonial">
								<blockquote>
									<q>Good website to check movie reviews from various sources at one place.
									You can read full-length reviews of a movie and filter them by publication date and critic score
									 or user score by clicking on their respective tabs at the top of the page.</q>
								</blockquote>
								<div class="testi-des">
					...
					<div class="item">
						<div class="testimonial-content">
							<div class="testimonial">
								<blockquote>
									<q>Most popular movie site with a user-generated rating feature.
									It provides all the necessary information like reviews, ratings, images, videos, etc.
									 that you may need to decide if the movie is worth watching or not.</q>
								</blockquote>
								<div class="testi-des">
					...
					<div class="item">
						<div class="testimonial-content">
							<div class="testimonial">
								<blockquote>
									<q>Great site to find out what the overall critical opinion is about a movie.
									This includes a list of what other people who liked that movie also liked, as well as reviews from professional critics and user ratings.</q>
								</blockquote>
								<div class="testi-des">
									<div class="test-img"><img src="assets/images/team2.jpg" class="img-fluid" alt="/">
									</div>
					...
					<div class="item">
						<div class="testimonial-content">
							<div class="testimonial">
								<blockquote>
									<q>Movie review sites have other useful information like trailers,
									 showtimes and tickets, DVD release dates, and more.</q>
								</blockquote>
								<div class="testi-des">
									<div class="test-img"><img src="assets/images/team3.jpg" class="img-fluid" alt="/">
									</div>
